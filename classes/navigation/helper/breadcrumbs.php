 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Navigation_Helper_Breadcrumbs
    extends Navigation_Helper_Abstract
{
    /**
     ...
     *
     * @param  Navigation_Container $container     [optional] container to
     *                                                  operate on
     * @return View_Helper_Navigation_Breadcrumbs  fluent interface,
     *                                                  returns self
     */
    public function breadcrumbs(Navigation_Container $container = null)
    {
        if (null !== $container) 
		{
     ...
     */
    public function renderStraight(Navigation_Container $container = null)
    {
        if (null === $container) 
		{
     ...
     * @return string                                helper output
     */
    public function renderPartial(Navigation_Container $container = null,
                                  $partial = null)
    {
        if (null === $container) 
		{
        ...
        if ($active = $this->findActive($container)) 
		{
            ...
            while ($parent = $active->getParent())
			{
                if ($parent instanceof Navigation_Page AND $parent->isVisible()) 
				{
                    $model['pages'][] = $parent;
                } 
				else 
    ...
    // View_Helper_Navigation_Helper:

    /**
     * Renders helper
     *
     * Implements {@link View_Helper_Navigation_Helper::render()}.
     *
     * @param  Navigation_Container $container  [optional] container to
     *                                               render. Default is to
     *                                               render the container
     ...
     * @return string                                helper output
     */
    public function render(Navigation_Container $container = null)
    {
